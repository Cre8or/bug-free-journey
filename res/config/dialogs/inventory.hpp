        ...
        class Controls {
                ...
                // TOP SLOTS
                        ...
                        class NVGs_Frame : RscText {
                                ...
                                x = _safeZoneX + _safeZoneW * (0.5 - MACRO_SLOT_SIZE_W * 2.5);
                                y = _safeZoneY + _safeZoneH * (0.15);
                                w = _safeZoneW * MACRO_SLOT_SIZE_W * 1.5;
                                h = _safeZoneH * MACRO_SLOT_SIZE_H * 1.5;
			...
			class Headgear_Frame : NVGs_Frame {
				...
				y = _safeZoneY + _safeZoneH * (0.15 + 0.005 + MACRO_SLOT_SIZE_H * 1.5);
				...
				x = _safeZoneX + _safeZoneW * (0.5 + MACRO_SLOT_SIZE_W);
				...
				x = _safeZoneX + _safeZoneW * (0.5 - MACRO_SLOT_SIZE_W * 2.5);
				y = _safeZoneY + _safeZoneH * (0.15 + 0.005 * 2 + MACRO_SLOT_SIZE_H * 3);
				w = _safeZoneW * MACRO_SLOT_SIZE_W * 5;
                                h = _safeZoneH * MACRO_SLOT_SIZE_H * 2;
                                colorBackground[] = CURLY(MACRO_COLOUR_ELEMENT_INACTIVE);
				...
				y = _safeZoneY + _safeZoneH * (0.15 + 0.005 * 3 + MACRO_SLOT_SIZE_H * 5);
				...
				y = _safeZoneY + _safeZoneH * (0.15 + 0.005 * 4 + MACRO_SLOT_SIZE_H * 7);
