...
case "ui_update_weapons": {
		...
		_ctrl setVariable ["defaultIconPath", _defaultIconPath];
                ...
                [_inventory displayCtrl MACRO_IDC_PRIMARYWEAPON_FRAME, 		MACRO_PICTURE_PRIMARYWEAPON],
                [_inventory displayCtrl MACRO_IDC_HANDGUNWEAPON_FRAME,		MACRO_PICTURE_HANDGUNWEAPON],
                [_inventory displayCtrl MACRO_IDC_SECONDARYWEAPON_FRAME,	MACRO_PICTURE_SECONDARYWEAPON],
